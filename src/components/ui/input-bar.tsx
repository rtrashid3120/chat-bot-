  ...
  return (
    <div className={cn("shrink-0 px-3 pb-3 w-full", className)}>
      <div className="mx-auto max-w-3xl">
        <div
          className="relative cursor-text rounded-[16px] bg-white dark:bg-neutral-900 shadow-sm ring-1 ring-neutral-200 dark:ring-neutral-800 transition-all hover:ring-neutral-300 dark:hover:ring-neutral-700 focus-within:ring-2 focus-within:ring-neutral-400 dark:focus-within:ring-neutral-600"
